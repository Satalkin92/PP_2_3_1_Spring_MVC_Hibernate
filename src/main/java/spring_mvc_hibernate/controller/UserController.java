...
public class UserController {
    ...
    private final UserService userServiceInterfaces;
    ...
    public String getUsers(ModelMap modelMap) {
        modelMap.addAttribute("users", userServiceInterfaces.getUsers());
        return "users";
    }

    @GetMapping("/users/delete")
    public String deleteUserById(@RequestParam("id") long id) {
        userServiceInterfaces.deleteUser(id);
        return "redirect:/users";
    }

    @PostMapping()
    public String createUser(@ModelAttribute("user") User user) {
        userServiceInterfaces.createUser(user);
        return "redirect:/users";
    }
    ...
    public String getUser(ModelMap modelMap, @RequestParam("id") long id) {
        modelMap.addAttribute(userServiceInterfaces.getUserById(id));
        return "updateUserForm";
    }

    @PostMapping("users/update")
    public String updateUser(@ModelAttribute("user") User user) {
        userServiceInterfaces.updateUser(user);
        return "redirect:/users";
    }
}
